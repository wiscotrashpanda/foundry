...
If the machine needs to be rebuilt from scratch, run `bootstrap.yml` from this
directory on a local machine with Ansible installed. This bootstrap run is the
only time local Ansible is required.
